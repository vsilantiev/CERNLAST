...
#Tue Dec 16 21:57:15 MSK 2014
Project.device.designInputFile=C\:\\Users\\vsilantiev\\Documents\\CERNLAST\\v6pcieDMA_cs.ngc
Project.device.designOutputFile=C\:\\Users\\vsilantiev\\Documents\\CERNLAST\\v6pcieDMA_cs.ngc
Project.device.deviceFamily=21
Project.device.enableRPMs=true
Project.device.outputDirectory=C\:\\Users\\vsilantiev\\Documents\\CERNLAST\\_ngo
Project.device.useSRL16=true
Project.filter.dimension=19
Project.filter<0>=
Project.filter<10>=fs_clk
Project.filter<11>=serdes_clk_buf
Project.filter<12>=clk_fb
Project.filter<13>=dco_clk
Project.filter<14>=serdes_clk
Project.filter<15>=trn_clk
Project.filter<16>=reg08_rv
Project.filter<17>=reg08_td
Project.filter<18>=reg08_rd
Project.filter<1>=\u044B
Project.filter<2>=BUFG
Project.filter<3>=send_ack
Project.filter<4>=control_iic<0>
Project.filter<5>=reg07_rv
Project.filter<6>=reg07_tv
Project.filter<7>=reset
Project.filter<8>=indicator
Project.filter<9>=reg08_td<0>
...
Project.unit<0>.triggerChannel<0><0>=cmp_fmc_adc_100Ms_core reg07_td<0>
